...
sudo pacman -Syyu --noconfirm go btrfs-assistant visual-studio-code-bin telegram-desktop rsync nano flatpak blanket #gnome-online-accounts gvfs-google gvfs-onedrive
